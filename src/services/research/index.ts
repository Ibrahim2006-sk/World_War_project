...
export type { ArxivPaper, SoftwareRepo, HackernewsItem };
...
const trendingBreaker = createCircuitBreaker<SoftwareRepo[]>({ name: 'Software Trending', cacheTtlMs: 10 * 60 * 1000, persistCache: true });
...
export async function fetchSoftwareRepos(
  language = 'python',
  period = 'daily',
  pageSize = 50,
): Promise<SoftwareRepo[]> {
